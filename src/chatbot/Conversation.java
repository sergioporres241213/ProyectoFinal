...
public class Conversation {
    ...
    public Conversation(){
        ...
        raiz = tree.root = new Node("Hola! ¿Cómo puedo ayudarte? contamos con las siguientes opciones:\n1. bloqueo de tarjeta\n2.saldo disponible\n3.fecha de corte\n4.fecha de pago\n5.Informacion de tarjeta");
        ...
        op6.palabra_clave[1] = "";
        op6.palabra_clave[2] = "";
        op6.salida = new Node("Por motivos de seguridad, esa opción no esta permitida por este medio. Intenta visitar tu banco mas cercano para poder obtener ayuda sobre tu tarjeta de credito");
        
        exit = raiz.salida = new Node("Lo siento, no puedo ayudarte con tu solicitud. Prueba con una opción para tu tarjeta de credito");
